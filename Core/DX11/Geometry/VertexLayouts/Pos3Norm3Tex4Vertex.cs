...
namespace FeralTic.DX11.Geometry
{
    ...
    public struct Pos3Norm3Tex4Vertex
    {
        public Vector3 Position;
        public Vector3 Normals;
        public Vector4 TexCd;
            ...
            get
            {
                if (layout == null)
                {
                    layout = new InputElement[]
                    {
                        ...
                        new InputElement("TEXCOORD",0,SlimDX.DXGI.Format.R32G32B32A32_Float,24,0),
                    };
                }
                return layout;
            }
        ...
        {
            get { return Marshal.SizeOf(typeof(Pos3Norm3Tex4Vertex)); }
        }
    }
}
